        ...
        <div className="why-visual">
          ...
          <div className="why-copy">
            <p className="why-lead">
              디자인필은 아이가 남긴 선과 색을 천천히 들여다봅니다.
              그 안에 담긴 그때의 모습과 이야기를 한 점의 작품으로 이어갑니다.
            </p>
            <p>
              아이의 그림은 잠시 남겨진 종이가 아니라, 한 시절의 마음과
              가족의 시간이 담긴 기록입니다. 디자인필은 그 기록이 오래 곁에 머물 수 있도록 정성껏 보존합니다.
            </p>
          </div>
        </div>
      </section>
